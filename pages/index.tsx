            ...
            >
              <div className="flex flex-col items-start justify-center max-w-xl lg:max-w-6xl mx-auto mb-16 dark:text-white space-y-10">
                <div className="flex-col justify-center items-center text-center">
                  {data ? (
                    <Fade
                      ...
                      distance="30px"
                    >
                      <h1 className="text-center pb-2 text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-t from-orangeDDTV to-orange-600 transition -rotate-2">
                ...
                <div className="flex justify-start">
                  <div className="grid grid-flow-col lg:grid-flow-col auto-rows-max space-x-14">
                    <div className="">
                      <iframe
                        ...
                        className="flex justify-start rounded-2xl w-72 lg:w-250 h-52 lg:h-250 md:w-96 md:h-72"
                      />
                    </div>
                    <div className="">
