    ...
    <>
      ...
      <div class="container-fluid p-slide">
        <div class="row">
          ...
          <div class="col">
            <div>
              <h1 className="orange big-font-size">COLLECTE</h1>
              ...
              <div className="step-card">
                ...
                <div className="card-num">
                  ...
                  <p className="card-number-text">
                    Les collectes peuvent débuter ! A chaque passage, notre équipe de Collectivores
                    échangera votre bac plein contre un bac vide désinfecté : simple et efficace !
                  </p>
                </div>
                <div className="card-num">
                  ...
                  <p className="card-number-text">
                    ...
                    pesés : étape essentielle à la réalisation d’un reporting propre à chacun de nos
                    usagers.
                  </p>
                </div>
              </div>
