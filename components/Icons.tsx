      ...
      return (
        ...
        >
          <g id="Layer_1" data-name="Layer 1">
            <path
              className="cls-1"
              d="M30.68,150.79H155.57c5.74,0,11.47,0,17.21,0H173a2.76,2.76,0,0,0,2.53-1.14c.39-.79-.34-1.44-1.13-1.44H49.53c-5.74,0-11.47,0-17.21,0h-.24a2.77,2.77,0,0,0-2.53,1.14c-.38.79.34,1.44,1.13,1.44Z"
            />
            <path
              className="cls-1"
              d="M112.1,133.45a5.61,5.61,0,0,1-1.79,4.06c-.1.09-.21.16-.31.24s-.35.23-.11.08l-.27.16c-.19.09-.19.09,0,0l-.22.09c-.32.09.48-.14,0,0s.28,0,0,0c-.09,0-.45,0-.09,0h-.34c-.48,0,.24.06-.24,0l-.32,0a3.33,3.33,0,0,1-.74-.22,5.46,5.46,0,0,1-2.37-1.88,6.1,6.1,0,0,1-.39-6.26,5,5,0,0,1,.88-1.23,3.81,3.81,0,0,1,.45-.4l.26-.19c-.25.17.14-.06.19-.09-.37.21.08,0,.14,0s-.41.1,0,0-.28.1,0,0-.42.05.08,0c.28,0,.17,0,.08,0a3,3,0,0,1,.51.06,4.45,4.45,0,0,1,.64.18,6.25,6.25,0,0,1,4,5.48c0,.94,3.87.29,3.87-1,0-2.72-2.33-5.25-4.78-6.15a8.65,8.65,0,0,0-9.42,2.78,6.94,6.94,0,0,0-.44,7.87c1.8,2.81,5.21,3.57,8.32,2.8a7.83,7.83,0,0,0,6.32-7.3C116,131.51,112.14,132.11,112.1,133.45Z"
            />
            <ellipse
              className="cls-1"
              cx="147.7"
