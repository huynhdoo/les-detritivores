              ...
              <div className="ml-2">
                ...
                <div className="negative">
                  <p className="light big-font-size-md m-12 text-start">
                    ...
                    fertiliser et de la structurer pour l’épanouissement de vos plantations. Mettre
                    une dose de compsot dans vos fleurs c’est également participer à la
                    végétalisation de notre territoire
                  </p>
                </div>
                <div>
                  <p className="light big-font-size-md m-12 text-start">
                    Apporter du compost à la Terre permet de la fertiliser et de la structurer pour
                    l’épanouissement de vos plantations. Mettre une dose de compsot dans vos fleurs
                    c’est également participer à la végétalisation de notre territoire.
                  </p>
                </div>
                <div className="row">
